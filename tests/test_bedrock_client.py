"""Tests for claudegate/bedrock_client.py."""

from unittest.mock import MagicMock, patch

from claudegate.bedrock_client import get_bedrock_client, reset_bedrock_client


class TestGetBedrockClient:
    def test_creates_client_on_first_call(self):
        mock_client = MagicMock()
        with patch("claudegate.bedrock_client.boto3") as mock_boto3:
